...
const getItem = (dropId, dataSource) => {
  ...
  dataSource.forEach(item => {
    if(dropId === 'new' && item.cardId === 0)
      data.push(item);
    else if(dropId === 'inProgress' && item.cardId === 1)
      data.push(item);
    else if(dropId === 'completed' && item.cardId === 2)
      data.push(item);
  });
  return data;
}
  ...
  onDragEnd = result => {
    ...
    if (source.droppableId === destination.droppableId) {
      ...
      if (source.droppableId === 'droppableId1') {
        ...
        this.setState({dataCompleted: items})
    } else {
        const result = move(
          this.getList(source.droppableId),
        ...
        if (source.droppableId === 'droppableId1' && destination.droppableId === 'droppableId2') {
          this.setState({
            dataNew: result.droppableId1,
            dataInProgress: result.droppableId2
          });
        } else if (source.droppableId === 'droppableId1' && destination.droppableId === 'droppableId3') {
            this.setState({
              dataNew: result.droppableId1,
              dataCompleted: result.droppableId3
            });
        } else if (source.droppableId === 'droppableId2' && destination.droppableId === 'droppableId1') {
            this.setState({
              dataInProgress: result.droppableId2,
              dataNew: result.droppableId1
            });
        } else if (source.droppableId === 'droppableId2' && destination.droppableId === 'droppableId3') {
            this.setState({
              dataInProgress: result.droppableId2,
              dataCompleted: result.droppableId3
            });
        } else if (source.droppableId === 'droppableId3' && destination.droppableId === 'droppableId1') {
            this.setState({
              dataCompleted: result.droppableId3,
              dataNew: result.droppableId1
            });
        } else if (source.droppableId === 'droppableId3' && destination.droppableId === 'droppableId2') {
            this.setState({
              dataCompleted: result.droppableId3,
              dataInProgress: result.droppableId2
            });
